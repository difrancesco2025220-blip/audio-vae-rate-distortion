...
so $c$ reflects both posterior uncertainty and local decoder sensitivity. The clearest transition occurs around $R\simeq223\rightarrow122$ nats/audio. Independent audio metrics show the same behavior, supporting that the effect is not specific to the weighted log-STFT loss.
